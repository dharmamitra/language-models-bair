...
MAX_SEQ_LEN = 512
SEED = 42
DATASET_NAME = "buddhist-nlp/daizhige-masked"


def main():
    tokenizer = AutoTokenizer.from_pretrained("google/mt5-xl")

    pretrain_dataset = load_dataset("buddhist-nlp/daizhige")["train"]
    ...
    pretrain_dataset_val = load_dataset("buddhist-nlp/daizhige")["validation"]
    ...
    pretrain_dataset_test = load_dataset("buddhist-nlp/daizhige")["test"]
